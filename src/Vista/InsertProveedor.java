...
public class InsertProveedor extends JDialog {
	...
	public static void main(String[] args) {
		try {
			InsertProveedor dialog = new InsertProveedor(null);
	 ...
	 * Create the dialog.
	 */
	public InsertProveedor(SessionFactory instancia) {
		...
		cancelButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setModal(false);
				setVisible(false);
				InsertProveedor.this.dispatchEvent(new WindowEvent(InsertProveedor.this, WindowEvent.WINDOW_CLOSING));
			}
		});
